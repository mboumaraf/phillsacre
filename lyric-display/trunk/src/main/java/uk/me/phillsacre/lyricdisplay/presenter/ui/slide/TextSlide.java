...
public class TextSlide implements Slide
{
    ...
    private void drawText(Graphics2D g2d, Rectangle bounds, String[] lines)
    {
	Graphics2D g = (Graphics2D) g2d.create();

	Font f = new Font("Helvetica", Font.PLAIN, 12);
	float pointSize = getSize(g2d, bounds, f, lines);
     ...
     * @return
     */
    private float getSize(Graphics2D g2d, Rectangle bounds, Font f,
	    String[] lines)
    {
