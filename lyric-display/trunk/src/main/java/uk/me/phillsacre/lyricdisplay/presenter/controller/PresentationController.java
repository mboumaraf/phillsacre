...
public class PresentationController
{
    ...
    private void bind()
    {
        EventBus.subscribeStrongly(
                ChangePresentationStateEvent.class, new EventSubscriber<ChangePresentationStateEvent>()
                {
                    @Override
        ...
        EventBus.subscribeStrongly( ChangeSlideEvent.class, new EventSubscriber<ChangeSlideEvent>()
        {
            @Override
        ...
        EventBus.subscribeStrongly( BlackoutEvent.class, new EventSubscriber<BlackoutEvent>()
        {
            @Override
    ...
    /**
     * Try to auto-select the graphics device based on the window that the main frame is NOT displaying on
     * 
     * @param devices
     * @return
     */
