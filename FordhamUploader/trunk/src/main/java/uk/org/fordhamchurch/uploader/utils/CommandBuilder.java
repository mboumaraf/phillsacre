...
/**
 * Utility class to help build an executable command (i.e. which will be run as a {@link Process}).
 * 
 * @author psacre
 */
public class CommandBuilder
{
    ...
    /**
     * Adds an argument which contains replacement placeholders. The string and parameters will be passed into
     * {@link String#format}.
     * 
     * @param arg
     * @param params
