...
/**
 * Class to convert a WAV file into an MP3. This uses the LAME encoder, requires
 * lame executable to be available.
 * 
 * @author psacre
 */
public class MP3Encoder
{
    ...
    public MP3Encoder(File wavFile, String title,
