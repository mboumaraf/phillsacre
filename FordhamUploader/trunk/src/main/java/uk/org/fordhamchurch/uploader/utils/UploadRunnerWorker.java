...
{
    private static final Log          LOG = LogFactory.getLog( UploadRunnerWorker.class );
    ...
    private File ripCD( ProgressListener progressListener )
    {
        ...
        try
        {
            ...
            LOG.debug( "Rip complete, file size is: " + rawFile.length() + " bytes" );
    ...
    private File convertToMP3( File wavFile, ProgressListener progressListener )
    {
        ...
        LOG.debug( "Encode complete, encoded file size is " + mp3.length() + " bytes" );
    ...
    private void uploadToWebsite( File mp3File, ProgressListener progressListener )
    {
        ...
        try
        {
            ...
            LOG.info( String.format( "Uploading [%s] to [%s]", mp3File.getName(), sftp.pwd() + "/" + _targetFilename ) );
